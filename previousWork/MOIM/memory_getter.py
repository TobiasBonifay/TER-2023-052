...
class MemoryGetter:
    ...
    def __init__(self):
        self.VM_CGROUP_DIR = "/sys/fs/cgroup/machine.slice/machine-qemu\\x2d6\\x2dubuntu22.04.scope/memory.max"
        self.VM_CGROUP_MAX_DIR = "/sys/fs/cgroup/machine.slice/machine-qemu\\x2d7\\x2dubuntu22.04\\x2d2.scope/libvirt/memory.max"
